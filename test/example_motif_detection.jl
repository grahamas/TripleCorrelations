...
#         raster_IV = TripleCorrelations.repeat_padded_motif("IV", l, l, 1, 1)
...
#         raster_IV_top = TripleCorrelations.repeat_padded_top_motif("IV", l, l, 1, 1)
...
#         raster_IV = TripleCorrelations.repeat_padded_motif("IV", 30, 30, 1, 1)
...
#         raster_IV_top = TripleCorrelations.repeat_padded_top_motif("IV", 30, 30, 1, 1)
...
@testset "Zeropadding, unrolled" begin
    ...
    @testset "Sequence Motif V TOP" begin
        ...
        contributions_IV_top = sequence_class_tricorr_unrolled(raster_IV_top, ZeroPadded(), (l, l))
        @test contributions_IV_top[5] > 0 && all(contributions_IV_top[begin+5:end] .== 0)
    end
    ...
    @testset "Sequence Motif XIII" begin
        ...
        contributions_XIII = @btime sequence_class_tricorr_unrolled($raster_XIII, ZeroPadded(), (l, l))
        @test contributions_XIII[14] > 0 && all(contributions_XIII[begin+14:end] .== 0)
    end
end
...
@testset "Periodic, unrolled" begin
    ...
    @testset "Sequence Motif V TOP" begin
        ...
        contributions_IV_top = sequence_class_tricorr_unrolled(raster_IV_top, Periodic(), (l, l))
        @test contributions_IV_top[5] > 0 && all(contributions_IV_top[begin+5:end] .== 0)
    end
    ...
    @testset "Sequence Motif XIII" begin
        ...
        contributions_XIII = @btime sequence_class_tricorr_unrolled($raster_XIII, Periodic(), (l, l))
        @test contributions_XIII[14] > 0 && all(contributions_XIII[begin+14:end] .== 0)
    end
end