...
@testset "PeriodicExtended" begin
    @testset "Sequence Motif 0" begin
        ...
        boundary = PeriodicExtended((1+l, size(raster,2)-l))

        contributions_0 = sequence_class_tricorr(raster, boundary, (l, l))
        @test contributions_0[1] == sum(raster[:,boundary.t_bounds[1]:boundary.t_bounds[2]]) / TripleCorrelations.calculate_scaling_factor(raster, boundary) && all(contributions_0[begin+1:end] .== 0)
        @test contributions_0[10] == 0
    end
    ...
    @testset "Sequence Motif I" begin
        ...
        contributions_I = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_I[2] > 0 && all(contributions_I[begin+2:end] .== 0)
    end
    ...
    @testset "Sequence Motif II" begin
        ...
        contributions_II = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_II[3] > 0 && all(contributions_II[begin+3:end] .== 0)
    end
    ...
    @testset "Sequence Motif III" begin
        ...
        contributions_III = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_III[4] > 0 && all(contributions_III[begin+4:end] .== 0)
    end
    ...
    @testset "Sequence Motif IV" begin
        ...
        contributions_IV = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_IV[5] > 0 && all(contributions_IV[begin+5:end] .== 0)
    end
    ...
    @testset "Sequence Motif V TOP" begin
        ...
        contributions_IV_top = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_IV_top[5] > 0 && all(contributions_IV_top[begin+5:end] .== 0)
    end
    ...
    @testset "Sequence Motif V" begin
        ...
        contributions_V = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_V[6] > 0 && all(contributions_V[begin+6:end] .== 0)
    end
    ...
    @testset "Sequence Motif VI" begin
        ...
        contributions_VI = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_VI[7] > 0 && all(contributions_VI[begin+7:end] .== 0)
    end
    ...
    @testset "Sequence Motif VII" begin
        ...
        contributions_VII = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_VII[8] > 0 && all(contributions_VII[begin+8:end] .== 0)
    end
    ...
    @testset "Sequence Motif VIII" begin
        ...
        contributions_VIII = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_VIII[9] > 0 && all(contributions_VIII[begin+9:end] .== 0)
    end
    ...
    @testset "Sequence Motif X" begin
        ...
        contributions_X = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_X[11] > 0 && all(contributions_X[begin+11:end] .== 0)
    end
    ...
    @testset "Sequence Motif IX" begin
        ...
        contributions_IX = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_IX[10] > 0 && all(contributions_IX[begin+10:end] .== 0)
    end
    ...
    @testset "Sequence Motif XI" begin
        ...
        contributions_XI = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_XI[12] > 0 && all(contributions_XI[begin+12:end] .== 0)
    end
    ...
    @testset "Sequence Motif XII" begin
        ...
        contributions_XII = sequence_class_tricorr(raster, PeriodicExtended((1+l, size(raster,2)-l)), (l, l))
        @test contributions_XII[13] > 0 && all(contributions_XII[begin+13:end] .== 0)
    end
